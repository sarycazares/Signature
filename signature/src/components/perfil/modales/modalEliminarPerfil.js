...
export default function ModalEliminarPerfil() {
  ...
  return (
    <>
      ...
      <abbr onClick={handleShow} title="EliminarPerfil" id="CerrarSesionModal"><a className="categoria" id="CerrarSesionCategoria"><img src={require('../../../recursos/images/icons/comment-x-solid-24.png')}/></a></abbr>
